      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={styles.loginHead}>
            <p style={styles.welcomeTag}>Get Started</p>
            <h1 style={{ ...styles.h1, fontSize: isMobile ? 22 : 26 }}>Create an account</h1>
          ...
          <form onSubmit={handleSubmit} style={styles.form}>
            ...
            >
              {loading
                ? <><Loader2 size={16} style={styles.spin} /> Signing up…</>
          ...
          <div style={styles.signupPrompt}>
            ...
            <button onClick={() => navigate('/login')} style={styles.signupLink}>
              Sign in
            </button>
          </div>
        </div>
